...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Oct 03, 2022 at 04:14 PM
...
(35, 'Nguyễn', 'Nhi', NULL, '2022-10-02 00:00:00');
...
--
ALTER TABLE `courseinstructor`
  ADD CONSTRAINT `courseinstructor_ibfk_1` FOREIGN KEY (`PersonID`) REFERENCES `person` (`PersonID`) ON DELETE CASCADE ON UPDATE CASCADE,
